...
public class FitnessTrainingSessionBean {
	...
	public String toString() {
		return  "userid:" + getUserid()
				...
				+ "-" + "hrz2Time:" 		+ getHrz2Time() 	+ "-"
				+ "-" + "hrz2Distance:" 	+ getHrz2Distance() + "-"
				+ "-" + "hrz3Time:" 		+ getHrz3Time() 	+ "-"
				+ "-" + "hrz3Distance:" 	+ getHrz3Distance() + "-"
				+ "-" + "hrz4Time:" 		+ getHrz4Time() 	+ "-"
				+ "-" + "hrz4Distance:" 	+ getHrz4Distance() + "-"
				+ "-" + "hrz5Time:" 		+ getHrz5Time() 	+ "-"
				+ "-" + "hrz5Distance:" 	+ getHrz5Distance() + "-"
				+ "-" + "hrz6Time:" 		+ getHrz6Time() 	+ "-"
				+ "-" + "hrz6Distance:" 	+ getHrz6Distance() + "-"
