...
public class TraineeSureshRegression extends JerseyTest{
	...
	public void traineeSureshRegressionTest() throws Exception {
		...
		Assert.assertEquals(108.99, heartrateZones0.getDouble("heartrateZone1End"));
		Assert.assertEquals(108.99, heartrateZones0.getDouble("heartrateZone2Start"));
		Assert.assertEquals(127.49, heartrateZones0.getDouble("heartrateZone2End"));
		Assert.assertEquals(127.49, heartrateZones0.getDouble("heartrateZone3Start"));
		Assert.assertEquals(142.0, heartrateZones0.getDouble("heartrateZone3End"));
		Assert.assertEquals(142.0, heartrateZones0.getDouble("heartrateZone4Start"));
		Assert.assertEquals(147.98, heartrateZones0.getDouble("heartrateZone4End"));
		Assert.assertEquals(147.98, heartrateZones0.getDouble("heartrateZone5Start"));
		...
		Assert.assertEquals(105.99, heartRateZones1.getDouble("heartrateZone1End"));
		Assert.assertEquals(105.99, heartRateZones1.getDouble("heartrateZone2Start"));
		Assert.assertEquals(125.99, heartRateZones1.getDouble("heartrateZone2End"));
		Assert.assertEquals(125.99, heartRateZones1.getDouble("heartrateZone3Start"));
		Assert.assertEquals(141.76, heartRateZones1.getDouble("heartrateZone3End"));
		Assert.assertEquals(141.76, heartRateZones1.getDouble("heartrateZone4Start"));
		Assert.assertEquals(148.1, heartRateZones1.getDouble("heartrateZone4End"));
		Assert.assertEquals(148.1, heartRateZones1.getDouble("heartrateZone5Start"));
		...
		Assert.assertEquals(103.99, heartRateZones3.getDouble("heartrateZone1End"));
		Assert.assertEquals(103.99, heartRateZones3.getDouble("heartrateZone2Start"));
		Assert.assertEquals(124.99, heartRateZones3.getDouble("heartrateZone2End"));
		Assert.assertEquals(124.99, heartRateZones3.getDouble("heartrateZone3Start"));
		Assert.assertEquals(141.6, heartRateZones3.getDouble("heartrateZone3End"));
		Assert.assertEquals(141.6, heartRateZones3.getDouble("heartrateZone4Start"));
		Assert.assertEquals(148.18, heartRateZones3.getDouble("heartrateZone4End"));
		Assert.assertEquals(148.18, heartRateZones3.getDouble("heartrateZone5Start"));
