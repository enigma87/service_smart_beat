...
fb.Router = Backbone.Router.extend({
    ...
    userid: function () {
        $('#content').html('<div class="breadcrumb api">FB.api("/me/feed", "post", Karuna);</div>');
        $('#content').append(new fb.views.UserID().el);
    },
    postui: function () {
...
$(document).on('ready', function() {
    ...
    fb.templateLoader.load(['shell', 'welcome', 'login', 'person', 'friends', 'feed', 'post', 'userid', 'postui', 'error', 'revoke'], function () {
